...
require "modul/function.php";
    ...
    if(isset($_POST["submit"])){
        ...
        if(invoice_create($_POST) > 0){
            echo "
                <script>
                    document.location.href = '?x=invoice_barang&Id=$no_invoice';
                </script>
            ";
        }else{
            echo "
                <script>
                    document.location.href = '?x=invoice_create';
                </script>
            ";
        }
    }
    ...
    <body>
        <form action="" method="POST" class="offset-md-2 col-md-8 border border-secondary rounded mt-5 shadow-sm">
        	<div class="form-group col-md-12 text-center">
            	<h2 class="page-header mt-4">Tambah Data Invoice</h2>
