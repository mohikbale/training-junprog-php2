    ...
    <body>
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Data Surat Jalan</h1>
                <ol class="breadcrumb">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9 text-capitalize"><i class="fas fa-table mr-1"></i>Data Surat Jalan</div>
                            <div class="col-md-3">
                                 <a href="?x=suratjalan_create"><button class="btn btn-primary btn-sm float-right" style="width:100%;font-family: tahoma;"><div class="fas fa-plus-circle"></div> Tambah Data Surat Jalan</button></a>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-hover table-sm" id="dataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr class="small">
                                        ...
                                        <th style="width: 13%">No. Surat Jalan</th>
